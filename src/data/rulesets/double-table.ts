            ...
            content: [
                {
                    ...
                    paragraphs: [
                        {
                            content:
                                "Alle Becher (20 pro Team) müssen vor Spielbeginn in zwei 2D-Pyramidenformationen auf den beiden Tischen aufgestellt werden (mehr dazu unter [[ref:becherformation]]).",
                        },
                        {
                            content:
                ...
                },
                {
                    ...
                    paragraphs: [
                        ...
                        {
                            content:
                                "Die Pyramidenformationen sind entweder auf die eingezeichneten Stellen auf dem Bierpongtischen zu stellen oder die hinteren vier Becher müssen jeweils an die hintere Tischkante gestellt werden.",
                        },
                    ],
                },
            ],
                    ...
                    content: [
                        {
                            ...
                            paragraphs: [
                                ...
                                {
                                    content:
                                        "Es dürfen auch Becher vom eigenen, anderen Tisch entfernt werden.",
                                },
                            ],
                        },
                        {
                        ...
                        },
                        {
                            ...
                            paragraphs: [
                                {
                                    content:
                                        "Eine spielende Person kann das andere Team auffordern, die Becher zu richten. Mit Richten ist nur das Rejustieren des Bechers an seine ursprüngliche Position gemeint. Das gegenerische Team muss dieser Aufforderung nachkommen und die Becher richten.",
                                },
                                {
                                    content:
                                ...
                                {
                                    content:
                                        "Jedes Team darf seine Becher nur einmal pro Tisch und unabhängig voneinander im ganzen Spiel zusammenstellen.",
                                },
                                {
                                    content:
                                        "Es dürfen nur Becher von einem Tisch zusammen gestellt werden. Es ist nicht erlaubt, die Becher der beiden Tische zusammenzustellen.",
                                },
                            ],
                        },
                    ],
