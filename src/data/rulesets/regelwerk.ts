            ...
            content: [
                {
                    ...
                    paragraphs: [
                        {
                            content:
                                "Alle Becher (10 pro Team) müssen vor Spielbeginn in einer 2D-Pyramidenformation aufgestellt werden (mehr dazu unter [[ref:becherformation]]).",
                        },
                        {
                            content:
            ...
            content: [
                {
                    ...
                    paragraphs: [
                        {
                            content:
                                "Es gibt keine allgemeinen Turnierabläufe. Wie genau sich ein Turnier abspielt, hängt ganz davon ab, wie viele Personen da sind und ob ein Einzel- oder ein Teamturnier gespielt wird. Weitere Einzelheiten werden vor Ort geklärt.",
                        },
                    ],
                },
            ],
                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            paragraphs: [
                                {
                                    content:
                                        "Alle getroffenen Becher, die von den ersten zwei Bällen jeder Runde getroffen wurden, werden erst entfernt, wenn beide Würfe vorbei sind.",
                                },
                                {
                                    content:
                                        "Bei jedem Spezialwurf wird der Spezialbecher immer entfernt.",
                                },
                                {
                                    content:
                                        "Bei Spezialwürfen, bei denen mehr als nur der getroffene Becher entfernt wird, werden zuerst angrenzende Becher entfernt. Erst danach dürfen Becher entfernt werden, die nicht direkt an den Spezialbecher angrenzen.",
                                },
                                {
                                    content:
                        ...
                        },
                        {
                            ...
                            paragraphs: [
                                {
                                    content:
                                        "Bei der Millane-Technik, wenn eine Person seitlich vom Tisch steht, muss der Ellenbogen immer noch hinter der verlängerten Tischkante bleiben.",
                                },
                                {
                                    content:
                                        "Die Millane-Technik darf nur angewendet werden, wenn dadurch keine andere Person behindert wird.",
                                },
                            ],
                        },
                        {
                            ...
                            paragraphs: [
                                ...
                                {
                                    content:
                                        "Eine spielende Person kann das andere Team auffordern, die Becher zusammenzustellen. Die Formation darf sich das eigene Team aussuchen.",
                                },
                                {
                                    content:
                                        "Jedes Team darf seine Becher nur einmal im ganzen Spiel zusammenstellen.",
                                },
                            ],
                        },
                        {
                            ...
                            paragraphs: [
                                {
                                    content:
                                        "Eine spielende Person kann das andere Team auffordern, den Ball aus einem Becher zu entfernen, wenn er darin ist. Das gegnerische Team darf dies auch ohne Aufforderung tun.",
                                },
                            ],
                        },
                    ],
            ...
            content: [
                ...
                },
                {
                    ...
                    paragraphs: [
                        {
                            content:
                                "Die Gewinner des [[ref:art-7-auswerfen]] fangen nun mit den zwei regulären Würfen an.",
                        },
                        {
                            content:
                ...
                },
                {
                    ...
                    paragraphs: [
                        {
                            content:
                                "Das Spiel endet, sobald ein Team keine Becher mehr hat und der Punkt [[ref:art-10-konter]] abgehandelt wurde.",
                        },
                        {
                            content:
                        ...
                        {
                            content:
                                "Das Team, das weniger Becher auf der eigenen Seite stehen hat, hat gewonnen.",
                        },
                    ],
                },
                {
                    ...
                    paragraphs: [
                        ...
                        {
                            content:
                                "Nach einem erfolgreichen Konter bleiben alle Becher der letzten beiden Runden stehen und werden nicht weggestellt. Das Team, welches das Spiel fast gewonnen hätte, ist nun wieder an der Reihe.",
                        },
                    ],
                },
            ],
            ...
            content: [
                ...
                },
                {
                    ...
                    paragraphs: [
                        {
                            content:
                                "Wenn ein Team während des Spiels einen oder mehrere eigene Becher umwirft, muss ein eigener Becher entfernt werden.",
                        },
                        {
                            content:
                ...
                },
                {
                    ...
                    paragraphs: [
                        {
                            content:
                                "Es ist nicht erlaubt, einen Ball, der noch nicht komplett im Becher ist, mit Blasen oder Fingern zu retten.",
                        },
                    ],
                },
                {
                    ...
                    paragraphs: [
                        ...
                        {
                            content:
                                "Wenn ein Trickshot-Ball auf die eigene Tischhälfte zurückrollt, kann dieser ebenfalls geholt werden, und ein weiterer Trickshot kann gemacht werden.",
                        },
                        {
                            content:
