                    ...
                    content: [
                        {
                            ...
                            title: "Werfen",
                            paragraphs: [
                                { content: "Jedes Team hat in jeder Runde x Standardwürfe. Hierbei steht x für die Anzahl an Bällen, mit denen gespielt wird." },
                                ...
                                { content: "Im Falle eines Teamspiels ist es erlaubt, dass alle Bälle gleichzeitig geworfen werden." },
            ...
            content: [
                {
                    ...
                    title: "Spielablauf",
                    paragraphs: [
                        { content: "Die Gewinner des [[ref:art-7-auswerfen]] fangen nun mit den regulären x Würfen an." },
            ...
            content: [
                {
                    ...
                    title: "Balls Back",
                    paragraphs: [
                        { content: "Wenn in einer Wurfrunde alle Würfe getroffen werden, darf das aktuelle Team erneut werfen." },
                        { content: "Bevor erneut geworfen wird, müssen alle getroffenen Becher entfernt werden." }
                    ]
                },
                {
                    id: "art-16-bombe",
                    title: "Bombe",
                    paragraphs: [
                        { content: "Wenn in einer Wurfrunde alle Würfe eines Teams den gleichen Becher treffen, müssen dieser Becher und zwei weitere Becher entfernt werden." },
