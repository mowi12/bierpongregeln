                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            paragraphs: [
                                ...
                                { content: "Im Falle eines Einzelspiels ist es erlaubt, dass beide Bälle gleichzeitig geworfen werden." },
                                { content: "Im Falle eines Teamspiels ist es erlaubt, dass beide Bälle gleichzeitig geworfen werden." },
                                { content: "Sollte ein Ball während des Wurfs aus der Hand rutschen oder fallen, zählt dieser als geworfen und kann nicht erneut geworfen werden." },
            ...
            content: [
                {
                    ...
                    title: "Todesbecher",
                    paragraphs: [
                        { content: "Wenn am Ende einer Runde ein getroffener Becher stehen bleibt, zählt dieser Becher als Todesbecher. Wenn das gegnerische Team in einer der nachfolgenden Runden diesen Becher trifft, hat das Team, das den Todesbecher getroffen hat, sofort gewonnen." },
                        { content: "Wenn eine Person des Teams mit dem Todesbecher bemerkt, dass sie einen Todesbecher haben, dürfen sie diesen Becher umgehend entfernen." }
                    ]
                },
                {
                    id: "art-insel",
                    title: "Insel",
                    paragraphs: [
                        { content: "Wenn ein Becher allein steht, also keine Nachbarn hat, kann ein Spieler Insel auf diesen Becher rufen. Wird dieser getroffen, müssen der getroffene Becher und ein weiterer Becher entfernt werden. Wird anstelle des Insel-Bechers ein anderer Becher getroffen, zählt der Treffer nicht." },
                        { content: "Jeder Spieler darf im gesamten Spiel einmal Insel rufen." },
                        { content: "Die Anzahl an Insel-Rufen begrenzt sich pro Team auf zwei, selbst wenn ein Team aus mehr als zwei Spielern besteht." }
                    ]
                },
                {
                    id: "art-air-ball",
                ...
                },
                {
                    ...
                    title: "Gentle(wo-)men",
                    paragraphs: [
                        { content: "Wenn nur noch zwei Becher eines Teams stehen, kann das gegnerische Team sie dazu auffordern, die Becher hintereinander an die Spitze des Dreiecks zu stellen, welche in Richtung des gegnerischen Teams zeigt." },
                        { content: "Das Team mit den zwei verbleibenden Bechern kann das freiwillig machen, sobald der Fall eintritt und muss es machen, wenn das gegnerische Team es dazu auffordert." }
                    ]
                },
                {
                    id: "art-abfangen",
                    title: "Abfangen",
                    paragraphs: [
                        { content: "Wenn ein Ball, welcher kein [[ref:art-12-aufsetzer]] oder [[ref:art-air-ball]] ist, also noch kein Gegenstand berührt hat, sich vor der Tischkante befindet und sich somit in der Luft befindet, von einem gegnerischen Spieler berührt wird, so zählt das als Abfangen des Balls." },
                        { content: "Das Abfangen eines Balls stellt einen nicht regelkonformen, irreversiblen Eingriff in das Spiel dar und wird mit der sofortigen Niederlage des gegnerischen bzw. dem sofortigen Gewinn des werfenden Teams bestraft." },
                        { content: "Ein Ball zählt nicht als abgefangen, wenn ein Spieler gerade dabei ist die Becher [[ref:art-5-becher-richten]] oder ein Ball [[ref:art-6-ball-entfernen]]. Werfen während dieser Aktionen ist untersagt." }
                    ]
                }
            ]
        },
            ...
            content: [
                {
                    ...
                    paragraphs: [
                        ...
                        { content: "Insel mit Aufsetzer &rarr; Inselbecher + ein weiterer (Insel) + ein Becher Aufsetzer" },
                        { content: "Bombe mit Insel &rarr; Bomben-/ Inselbecher + zwei weitere (Bombe) + ein weiterer (Insel)" },
                        { content: "Bombe mit Doppel-Insel &rarr; Bomben-/ Inselbecher + zwei weitere (Bombe) + zwei weitere (Insel)" }
                    ]
                }
            ]
        }
