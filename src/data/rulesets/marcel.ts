                    ...
                    content: [
                        {
                            ...
                            title: "Trinken",
                            paragraphs: [
                                { content: "Wenn ein Becher getroffen wird, muss die Person, die den Becher getroffen hat, die vor dem Spiel vereinbarte Menge, trinken." },
                                ...
                                { content: "Wenn ein Teammitglied vergisst vor der nächsten Runde zu trinken, so zählt der Becher nicht als getroffen und wird wieder an seinen alten Platz gestellt. Sollte durch das Wegstellen des Bechers die Anordnung aller Becher verändert worden sein, so muss die alte Aufstellung wieder hergestellt werden." }
                            ]
                        }
                    ]
                }
            ...
            content: [
                {
                    ...
                    paragraphs: [
                        ...
                        { content: "Ein Ball, welcher mindestens einmal auf einem Becher aufgesetzt hat oder rollt und in einem Becher landet, zählt nicht als Aufsetzer, bekommt dafür aber einen weiteren Wurf." }
                    ]
                },
                {
                    id: "art-16-bombe",
